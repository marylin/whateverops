...
import { parsePanel, getHealthStatus, getCacheKey } from '../../../../backend/src/integrations/anthropic'
import fixture from '../../../fixtures/mock-responses/anthropic.json'
...
describe('anthropic integration', () => {
  it('parsePanel() with healthy mock response', () => {
    ...
    expect(panel.modelCount).toBe(3)
    expect(panel.availableModels).toContain('claude-opus-4-6')
  })
