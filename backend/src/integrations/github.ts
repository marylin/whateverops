  ...
  if (process.env.MOCK_PREVIEW === 'true') {
    ...
    return {
      repos: [
        {
          name: 'acme-dashboard',
          full_name: 'acme-org/acme-dashboard',
          html_url: 'https://github.com/acme-org/acme-dashboard',
          stargazers_count: 42,
          open_issues_count: 3,
          forks_count: 5,
          language: 'TypeScript',
        ...
        {
          name: 'acme-api',
          full_name: 'acme-org/acme-api',
          html_url: 'https://github.com/acme-org/acme-api',
          stargazers_count: 18,
          open_issues_count: 1,
          forks_count: 2,
          language: 'TypeScript',
        ...
        {
          name: 'acme-mobile',
          full_name: 'acme-org/acme-mobile',
          html_url: 'https://github.com/acme-org/acme-mobile',
          stargazers_count: 7,
          open_issues_count: 0,
          forks_count: 1,
          language: 'TypeScript',
        ...
        {
          name: 'acme-docs',
          full_name: 'acme-org/acme-docs',
          html_url: 'https://github.com/acme-org/acme-docs',
          stargazers_count: 3,
          open_issues_count: 0,
          forks_count: 0,
          language: 'MDX',
        ...
        {
          name: 'acme-cli',
          full_name: 'acme-org/acme-cli',
          html_url: 'https://github.com/acme-org/acme-cli',
          stargazers_count: 12,
          open_issues_count: 1,
          forks_count: 3,
          language: 'TypeScript',
      ...
      primaryRepo: 'acme-org/acme-dashboard',
      repo: {
        stargazers_count: 42,
        open_issues_count: 3,
        forks_count: 5,
      ...
      issues: [
        {
          ...
          created_at: d(5),
          updated_at: d(1),
          html_url: 'https://github.com/acme-org/acme-dashboard/issues/47',
        },
        {
          number: 45,
          ...
          created_at: d(8),
          updated_at: d(2),
          html_url: 'https://github.com/acme-org/acme-dashboard/issues/45',
        },
        {
          number: 43,
          title: 'Improve loading skeleton for cards',
          state: 'open',
          user: 'dev-a',
          labels: ['enhancement'],
          created_at: d(12),
          updated_at: d(4),
          html_url: 'https://github.com/acme-org/acme-dashboard/issues/43',
        },
      ],
      pullRequests: { total_count: 2 },
      recentCommit: {
        sha: 'a1b2c3d',
        message: 'feat: add user analytics endpoint',
        date: d(0),
        author: 'dev-a',
        url: 'https://github.com/acme-org/acme-dashboard/commit/a1b2c3d',
      },
      workflowRuns: [
        {
          id: 1001,
          ...
          created_at: d(0),
          updated_at: now,
          html_url: 'https://github.com/acme-org/acme-dashboard/actions/runs/1001',
          run_number: 88,
          event: 'push',
        },
        {
          ...
          status: 'in_progress',
          conclusion: null,
          head_branch: 'feat/analytics',
          created_at: d(0),
          updated_at: now,
          html_url: 'https://github.com/acme-org/acme-dashboard/actions/runs/1002',
          run_number: 87,
          event: 'pull_request',
        },
        {
          ...
          created_at: d(1),
          updated_at: d(1),
          html_url: 'https://github.com/acme-org/acme-dashboard/actions/runs/1003',
          run_number: 86,
          event: 'push',
        },
      ],
      dependabotAlerts: [
        {
          ...
          package_name: 'lodash',
          created_at: d(3),
          html_url: 'https://github.com/acme-org/acme-dashboard/security/dependabot/1',
        },
      ],
      traffic: {
        views: { count: 245, uniques: 62 },
        clones: { count: 18, uniques: 11 },
      },
      repoActivities: [
        {
          name: 'acme-dashboard',
          fullName: 'acme-org/acme-dashboard',
          htmlUrl: 'https://github.com/acme-org/acme-dashboard',
          openPRs: [
            {
              number: 52,
              title: 'feat: add user analytics endpoint',
              state: 'open',
              user: 'dev-a',
              created_at: d(1),
              updated_at: d(0),
              html_url: 'https://github.com/acme-org/acme-dashboard/pull/52',
              draft: false,
            },
            {
              number: 51,
              ...
              created_at: d(2),
              updated_at: d(1),
              html_url: 'https://github.com/acme-org/acme-dashboard/pull/51',
              draft: false,
            },
          ],
          recentRuns: [
        ...
        {
          name: 'acme-api',
          fullName: 'acme-org/acme-api',
          htmlUrl: 'https://github.com/acme-org/acme-api',
          openPRs: [
            {
              number: 31,
              ...
              created_at: d(3),
              updated_at: d(1),
              html_url: 'https://github.com/acme-org/acme-api/pull/31',
              draft: false,
            },
          ],
          recentRuns: [
            {
              ...
              created_at: d(1),
              updated_at: d(1),
              html_url: 'https://github.com/acme-org/acme-api/actions/runs/2001',
              run_number: 44,
              event: 'push',
            },
          ],
        ...
        {
          name: 'acme-mobile',
          fullName: 'acme-org/acme-mobile',
          htmlUrl: 'https://github.com/acme-org/acme-mobile',
          openPRs: [],
          recentRuns: [
            {
              id: 3001,
              ...
              created_at: d(3),
              updated_at: d(3),
              html_url: 'https://github.com/acme-org/acme-mobile/actions/runs/3001',
              run_number: 22,
              event: 'push',
            },
          ],
